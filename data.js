(function(root){
  ...
  const ITEM_TAGS=Object.freeze(["light_source","dim_light","harsh_light","bed","soft","floor","door","bridge","path","secret","shadow","window","heater","fire","cold","damp","mechanical","clock","noise","mechanical_noise","mirror","memory_object","personal","spiritual","protective","lock","water","fog","atmosphere","dream_object","organic","decoration","observation","centerpiece","furniture","advanced_result","living_machine","recording","time_anchor","stable_heat"]);
  const TAG_META=Object.freeze({
    light_source:{label:"照明",icon:"💡",composition:"lighting"},dim_light:{label:"柔和照明",icon:"🌙",composition:"lighting"},harsh_light:{label:"强光",icon:"☀",composition:"lighting"},bed:{label:"睡眠用品",icon:"🛏",composition:"sleep"},soft:{label:"柔软物件",icon:"🩶",composition:"sleep"},floor:{label:"地板",icon:"🪵",composition:"floor"},door:{label:"真实入口",icon:"🚪",composition:"door"},bridge:{label:"桥径",icon:"⌒",composition:"path"},path:{label:"路径",icon:"↝",composition:"path"},window:{label:"窗",icon:"🪟",composition:"window"},heater:{label:"取暖",icon:"🔥",composition:"heat"},fire:{label:"火源",icon:"🔥",composition:"heat"},cold:{label:"寒冷",icon:"❄",composition:"atmosphere"},damp:{label:"潮湿",icon:"💧",composition:"atmosphere"},mechanical:{label:"机械",icon:"⚙",composition:"mechanical"},clock:{label:"计时物",icon:"⏱",composition:"mechanical"},noise:{label:"噪声",icon:"🔇",composition:"atmosphere"},mechanical_noise:{label:"机械噪声",icon:"🔇",composition:"mechanical"},mirror:{label:"镜子",icon:"◇",composition:"decoration"},memory_object:{label:"记忆旧物",icon:"🧠",composition:"memory"},personal:{label:"私人旧物",icon:"✉",composition:"memory"},spiritual:{label:"灵异物件",icon:"👻",composition:"atmosphere"},protective:{label:"防护",icon:"🛡",composition:"protection"},lock:{label:"封闭装置",icon:"🔒",composition:"protection"},water:{label:"水景",icon:"💧",composition:"atmosphere"},fog:{label:"雾",icon:"🌫",composition:"atmosphere"},atmosphere:{label:"氛围",icon:"🌫",composition:"atmosphere"},dream_object:{label:"梦境物件",icon:"🌙",composition:"atmosphere"},organic:{label:"生命",icon:"♥",composition:"decoration"},decoration:{label:"装饰",icon:"✶",composition:"decoration"},observation:{label:"观察装置",icon:"👁",composition:"observation"},centerpiece:{label:"中央装置",icon:"◆",composition:"decoration"},furniture:{label:"家具",icon:"▰",composition:"furniture"},secret:{label:"隐秘入口",icon:"▥",composition:"door"},shadow:{label:"影界",icon:"◒",composition:"atmosphere"},advanced_result:{label:"高级反应结果",icon:"✦",composition:null},living_machine:{label:"机械生命",icon:"♥",composition:"mechanical"},recording:{label:"记录装置",icon:"◉",composition:"observation"},time_anchor:{label:"时间锚定",icon:"⌛",composition:"memory"},stable_heat:{label:"持续暖意",icon:"♨",composition:"heat"}
  });
  ...
  const TAG_OVERRIDES=Object.freeze({
    "electric-lamp":["light_source","harsh_light"],"soul-fire":["light_source","dim_light","spiritual"],"moon-lamp":["light_source","dim_light","dream_object"],"fog-lamp":["light_source","dim_light","fog","atmosphere"],"star-lantern":["light_source","dim_light"],"crystal-prism":["light_source","harsh_light"],"cold-light":["light_source","harsh_light"],"cold-mirror":["light_source","harsh_light","mirror"],"dream-bed":["bed","soft","dream_object","memory_object"],"cloud-bed":["bed","soft"],"wood-floor":["floor"],"wet-sand":["floor","water","damp"],"moss-floor":["floor","soft","organic","damp","cold"],fireplace:["heater","fire"],"steam-heater":["heater"],"warm-current":["heater","atmosphere"],"hearth-core":["heater","fire"],"warm-heart":["heater","organic"],"mechanical-clock":["mechanical","clock"],"mechanical-noise":["mechanical","noise","mechanical_noise","atmosphere"],"echo-bell":["noise","memory_object","decoration"],"wind-chime":["noise","decoration"],"memory-mirror":["mirror","memory_object"],"shadow-mirror":["mirror","spiritual"],mirror:["mirror"],"old-desk":["memory_object"],"memory-letter":["memory_object","personal","decoration"],"old-affection":["memory_object"],past:["memory_object"],"dark-door":["door"],"spirit-door":["door","spiritual"],"shadow-threshold":["door","spiritual"],"memory-door":["door","memory_object"],"veil-door":["door","fog"],"threshold-door":["door","lock"],"fog-window":["window","fog"],"dream-fog":["atmosphere","fog","dream_object"],moonlight:["atmosphere","dim_light","dream_object"],"quiet-breeze":["atmosphere","soft"],"ice-wind":["atmosphere","cold"],sandstorm:["atmosphere","noise"],"moon-pool":["water","dream_object","atmosphere","decoration","dim_light"],"frost-water":["water","cold","atmosphere","decoration"],"hourglass-sand":["clock","memory_object","observation","decoration"],"bone-armor":["protective","spiritual","decoration","organic"],"shadow-lock":["lock","protective","spiritual"],"time-seal":["lock","protective"],"memory-lock":["lock","memory_object"],"light-eye":["observation","light_source","harsh_light"],"electric-eye":["observation","mechanical"],"dream-eye":["observation","dream_object"],"signal-eye":["observation","mechanical"],"fog-bridge":["bridge","path","atmosphere","fog","dream_object","decoration"],"mechanical-heart":["mechanical","organic"],"gear-core":["mechanical","observation"],"rust-machine":["mechanical"],"mechanical-lab":["mechanical"]
  });
  const TAG_SPECIALIZATIONS=Object.freeze({
    "dark-door":["door","secret"],
    "spirit-door":["door","spiritual"],
    "shadow-threshold":["door","shadow","dream_object","spiritual"],
    "memory-door":["door","memory_object"],
    "shadow-mirror":["mirror","spiritual","shadow"],
    "shadow-lock":["lock","protective","spiritual","shadow"]
  });
  const normalizeItemTags=(tags=[],id="")=>{
    const source=TAG_SPECIALIZATIONS[id]||TAG_OVERRIDES[id]||tags||[];
  ...
  const normalizeRoomStats=(values={},context="roomStats")=>{const unknown=Object.keys(values||{}).filter(key=>!ATTRIBUTE_KEYS.includes(key));if(unknown.length)throw new TypeError(`${context} contains unsupported roomStats: ${unknown.join(", ")}`);return Object.fromEntries(ATTRIBUTE_KEYS.map(key=>{const raw=values?.[key]??0,number=Number(raw);if(!Number.isFinite(number)||number<0||number>5)throw new RangeError(`${context}.${key} must be between 0 and 5; received ${raw}`);return[key,number]}))};
  const attrs=(values={},context="attributes")=>normalizeRoomStats(values,context);
  const make=(id,label,level,category,iconKey,description,usageTags=[],options={})=>({
    ...
    libraryCategory:options.libraryCategory||null,attributes:attrs(options.attributes,`${id}.attributes`),
    ...
    roomRole:options.roomRole||null,roomUsable:options.roomUsable??Boolean(options.roomRole),resultType:options.resultType||"material",representation:options.representation||"element_token",compositionCategories:Object.freeze([...(options.compositionCategories||[])]),designPosition:options.designPosition||description,roomAction:options.roomAction||null,
  ...
  const rewardElements=[
    ...
    make("cloud","云",1,"base","dream","会改变轮廓和距离感的柔软材料。",["dream","soft","upgrade"],{libraryCategory:"奖励元素",attributes:{dream:1},roomEffects:{calmStrength:1}}),
    make("feather","羽毛",1,"base","wind","轻、安静，能够削弱尖锐的声音。",["soft","upgrade"],{libraryCategory:"奖励元素",roomEffects:{calmStrength:1}}),
    make("old-paper","旧纸",1,"base","memory","带着折痕、气味和手写痕迹的纸。",["memory","upgrade"],{libraryCategory:"奖励元素",attributes:{memory:1}}),
    make("gear","齿轮",1,"base","metal","可以把动力转化为稳定节律的机械零件。",["mechanical","upgrade"],{libraryCategory:"奖励元素",roomEffects:{mechanicalStrength:1}}),
  ...
  const lightProfiles={
    "electric-lamp":{attributes:{light:5,warmth:2,comfort:2},roomEffects:{calmStrength:1,mechanicalStrength:2},visual:{lightColor:"#ffd878",glowRadius:190,glowIntensity:.9,softness:.62,flickerAmount:0,particleType:"none",particleDensity:0}},
    ...
    "moon-lamp":{attributes:{light:2,comfort:2,eerie:0,dream:4},roomEffects:{calmStrength:5},visual:{lightColor:"#d4e4ff",glowRadius:104,glowIntensity:.4,softness:.96,flickerAmount:0,particleType:"moon_dust",particleDensity:3}},
    "fog-lamp":{attributes:{light:2,warmth:0,comfort:1,eerie:2,dream:3},roomEffects:{calmStrength:3},visual:{lightColor:"#d8ddd8",glowRadius:184,glowIntensity:.34,softness:1,flickerAmount:0,particleType:"mist",particleDensity:12}}
  };
  function LightComponent(element,profile){const visual={...profile.visual};return Object.assign(element,{roomRole:"light",roomUsable:true,resultType:"component",attributes:attrs(profile.attributes,`${element.id}.lightProfile.attributes`),roomEffects:{...(element.roomEffects||{}),...(profile.roomEffects||{})},visual,lightColor:visual.lightColor,glowRadius:visual.glowRadius,glowIntensity:visual.glowIntensity,particleType:visual.particleType})}
  ...
  const outputDefs={
    ...
    "moon-dust":["月尘",2,"material","moon","带有微弱月光的细小颗粒。",["dream","soft"],{attributes:{dream:1},roomEffects:{calmStrength:1}}],
    ...
    "rust-shard":["锈片",2,"material","metal","水侵蚀金属留下的时间碎片。",["memory","mechanical"],{attributes:{memory:1},roomEffects:{mechanicalStrength:1}}],
    static:["静电",2,"material","electricity","停留在空气中的短促能量。",["mechanical"],{roomEffects:{mechanicalStrength:1}}],
    ...
    "wind-chime":["风铃",3,"component","wind","会轻轻摇摆、让空间安静下来的挂件。",["wall","soft"],{roomRole:"wall",attributes:{comfort:1},roomEffects:{calmStrength:2},visual:{variant:"wind-chime"}}],
    "memory-mirror":["记忆镜",3,"component","mirror","映出旧日残片而非当前景象的墙镜。",["wall","memory","eerie"],{roomRole:"wall",attributes:{memory:3,eerie:1},roomEffects:{calmStrength:1},visual:{variant:"memory-mirror"}}],
    "dark-door":["暗门",3,"component","door","不显眼的秘密入口，藏得好，但并不主动闹鬼。",["door","secret","structure"],{roomRole:"door",attributes:{eerie:1},visual:{variant:"dark-door"}}],
    "fog-window":["雾窗",3,"component","fog","让窗外景象变得模糊、安静的窗。",["window","dream","soft"],{roomRole:"window",attributes:{dream:2},roomEffects:{calmStrength:1},visual:{variant:"fog-window"}}],
    ...
    "mechanical-clock":["机械钟",3,"component","time","用齿轮和滴答声记录房间节律。",["wall","mechanical"],{roomRole:"wall",roomEffects:{mechanicalStrength:4},visual:{variant:"mechanical-clock"}}],
    "moon-pool":["月光水池",3,"component","water","一池没有水声的月光，把安静的反光留在房间里。",["centerpiece","water","dream","atmosphere","decoration","dim_light"],{roomRole:"centerpiece",compositionCategories:["atmosphere","decoration"],designPosition:"把月光留在房间里的无声静态景观。",attributes:{light:1,dream:3},roomEffects:{calmStrength:3},visual:{variant:"moon-pool"}}],
    "dream-bed":["梦床",3,"component","dream","会把记忆带进梦里、但不一定让人睡得安稳的床。",["furniture","dream","memory"],{roomRole:"furniture",attributes:{comfort:2,dream:4,eerie:1,memory:1},roomEffects:{calmStrength:1},visual:{variant:"dream-bed"}}],
    ...
    "echo-bell":["回声铃",3,"component","wind","会让声音在房间中短暂回返的墙铃。",["wall","memory"],{roomRole:"wall",attributes:{memory:1},roomEffects:{calmStrength:1},visual:{variant:"echo-bell"}}],
    "star-lantern":["星灯",3,"component","star","把微小星光聚成柔和照明的灯。",["lighting","dream","soft"],{roomRole:"light",attributes:{light:3,comfort:2,dream:2},roomEffects:{calmStrength:1},visual:{variant:"star-lantern",lightColor:"#fff0a8",glowRadius:126,glowIntensity:.52,softness:.9,particleType:"moon_dust",particleDensity:5}}],
    "cloud-bed":["云床",3,"component","dream","像云一样稳定托住身体、适合安静休息的轻软睡床。",["furniture","soft"],{roomRole:"furniture",attributes:{comfort:5,warmth:1,dream:1,eerie:0},roomEffects:{calmStrength:4},visual:{variant:"cloud-bed"}}],
    "quiet-breeze":["静风",4,"atmosphere","wind","羽毛让空气变慢后形成的安静气流。",["atmosphere","soft"],{roomRole:"atmosphere",attributes:{comfort:1},roomEffects:{calmStrength:3,mechanicalSuppression:1},visualEffect:{type:"quiet-breeze",color:"#dce7df",density:5}}],
    "memory-letter":["旧信",3,"component","memory","字迹模糊、却能唤回私人记忆的旧信；它不是宏大的往昔，而是一件很私人的旧物。",["wall","memory","personal","decoration"],{roomRole:"wall",ownershipType:OWNERSHIP_TYPES.GUEST_GIFT,attributes:{memory:3,comfort:1},visual:{variant:"memory-letter"}}],
    "gear-core":["齿轮核心",3,"component","metal","仍在等待负载的动力种子，能听见齿轮内部尚未完成的节律。",["centerpiece","mechanical","observation"],{roomRole:"centerpiece",roomUsable:true,compositionCategories:["mechanical","observation"],designPosition:"尚未决定驱动什么、但明确通向高级机械链的动力种子。",attributes:{light:1},roomEffects:{mechanicalStrength:5},visual:{variant:"gear-core"}}],
    ...
    "moss-floor":["苔地板",3,"component","wood","从土地上生长出的柔软绿色地面，踩起来安静，却带着一点潮冷。",["floor","soft","organic","damp","cold"],{roomRole:"floor",attributes:{comfort:3,dream:1},roomEffects:{calmStrength:2},visual:{variant:"moss-floor"}}],
    ...
    "frost-water":["霜水",3,"component","water","低矮石盆里盛着冰层下仍缓慢流动的冷水，寒意会留在房间里。",["centerpiece","cold","water","atmosphere","decoration"],{roomRole:"centerpiece",roomUsable:true,ownershipType:OWNERSHIP_TYPES.CONSUMABLE,compositionCategories:["atmosphere","decoration"],designPosition:"把可见寒意带进客房的一盆冷水景观。",attributes:{dream:1,eerie:1},visual:{variant:"frost-water"}}],
    ...
    "hourglass-sand":["时砂漏",3,"component","time","沙粒无声落下，让人看见时间与记忆正在缓慢经过。",["wall","time","clock","memory","observation","decoration"],{roomRole:"wall",compositionCategories:["memory","decoration"],designPosition:"会让人意识到时间正在经过的无声记忆物。",attributes:{memory:3,dream:1},roomEffects:{calmStrength:1},visual:{variant:"hourglass-sand"}}],
    ...
    "spirit-door":["灵门",3,"component","door","只对灵魂痕迹开启，会让房间明显变得阴冷。",["door","spiritual","eerie"],{roomRole:"door",attributes:{eerie:4,memory:1},visual:{variant:"spirit-door"}}],
    ...
    "bone-armor":["骨甲",3,"component","bone","骨与金属共同形成的墙面护甲；既像怪异装饰，也确实能挡住什么。",["wall","protective","spiritual","decoration"],{roomRole:"wall",attributes:{eerie:2,memory:1},visual:{variant:"bone-armor"}}],
    ...
    "light-eye":["光眼",3,"component","eye","强光从瞳孔里追随来客：它在照亮房间，也像在看人。",["wall","light","vision","observation","harsh_light"],{roomRole:"wall",compositionCategories:["lighting","observation"],designPosition:"功能很强、却会制造被注视感的高副作用照明装置。",attributes:{light:4,eerie:2},visual:{variant:"light-eye",lightColor:"#f5f0c8",glowRadius:120,glowIntensity:.72}}],
    ...
    "shadow-threshold":["影门",3,"component","door","影子先于人穿过的梦境边界，深处并不遵循现实距离。",["door","shadow","dream","eerie"],{roomRole:"door",attributes:{eerie:3,dream:3},visual:{variant:"shadow-threshold"}}],
    ...
    "fog-bridge":["雾桥",3,"component","bridge","一条终点不在现实空间里的雾中路径，横穿客房却不通向门外。",["centerpiece","bridge","path","fog","atmosphere","dream","decoration"],{roomRole:"centerpiece",compositionCategories:["path","atmosphere"],designPosition:"让房间里出现一条不通往现实空间的路径。",attributes:{dream:3,eerie:2},roomEffects:{calmStrength:1},visual:{variant:"fog-bridge"}}],
    ...
    "shadow-lock":["影锁",3,"component","lock","没有锁舌与钥匙孔，只用一块阴影封住门后的东西。",["wall","lock","protective","spiritual","shadow","secret"],{roomRole:"wall",compositionCategories:["protection","decoration"],designPosition:"不靠机械结构、而靠影子封闭边界的灵性保护物。",attributes:{eerie:3,memory:1},visual:{variant:"shadow-lock"}}],
    ...
    "dream-fog":["梦雾",4,"atmosphere","fog","让整个空间柔化、像梦境一样缓慢流动。",["atmosphere","dream","soft"],{roomRole:"atmosphere",attributes:{dream:3},roomEffects:{lightPenalty:1,calmStrength:1},visualEffect:{type:"dream-fog",color:"#b9bfd4",density:10}}],
    moonlight:["月色",4,"atmosphere","moon","覆盖全室的淡冷白月光。",["atmosphere","dream","soft","lighting"],{roomRole:"atmosphere",attributes:{light:1,dream:2},roomEffects:{calmStrength:2},visualEffect:{type:"moonlight",color:"#cadcff",density:4}}],
    ...
    "memory-echo":["回忆残响",4,"atmosphere","memory","让旧日片段在空间里轻轻回返。",["atmosphere","memory"],{roomRole:"atmosphere",attributes:{memory:3,eerie:1},roomEffects:{calmStrength:1},visualEffect:{type:"memory-echo",color:"#b8d7c8",density:8}}],
    ...
    "breathing-drive":["呼吸驱动核",5,"component","heart","炉心与齿轮共同起伏，像一颗会呼吸的机械生命核心。",["advanced_result","mechanical","living_machine","organic","observation"],{roomRole:"centerpiece",compositionCategories:["mechanical","observation"],visualTraits:["heart","gear","fire"],attributes:{light:1,warmth:2,eerie:2},roomEffects:{mechanicalStrength:5,observationStrength:2},visual:{variant:"breathing-drive",lightColor:"#d98b69",glowRadius:104,glowIntensity:.32},designPosition:"会对房间变化作出脉动回应的机械生命；精密而略令人不安。",roomAction:"让机械装置像活物一样感知房间，并持续作出回应。"}],
    "echo-observatory":["回声观测台",5,"component","eye","信号眼被齿轮核心扩展成记录整间客房声光变化的观测台。",["advanced_result","mechanical","observation","recording","memory_object"],{roomRole:"wall",compositionCategories:["mechanical","observation","memory"],visualTraits:["eye","gear","wind"],attributes:{light:1,eerie:2,memory:3},roomEffects:{mechanicalStrength:3,observationStrength:5},visual:{variant:"echo-observatory"},designPosition:"不是单点扫描器，而是会留下客房活动记录的观察装置。",roomAction:"观察整间客房，并记录其中发生过的声光变化。"}],
    "time-anchor":["时序锚",5,"component","time","时砂与锈蚀机咬合，让房间的一小段时间稳定停驻。",["advanced_result","clock","memory_object","time_anchor","mechanical"],{roomRole:"wall",compositionCategories:["memory","mechanical"],visualTraits:["time","sand","metal"],attributes:{dream:2,eerie:1,memory:4},roomEffects:{timeStability:5,calmStrength:2,mechanicalStrength:1},visual:{variant:"time-anchor"},designPosition:"固定一段房间时间的锚点；让记忆清晰，却也会使变化变慢。",roomAction:"让房间里的一段时间缓慢下来，并把当时的痕迹留得更久。"}],
    "dream-road":["梦中雾径",5,"atmosphere","fog","梦砂的时间与雾桥重叠，在房间里铺出一条只在入睡后出现的路。",["advanced_result","path","bridge","fog","atmosphere","dream_object"],{roomRole:"atmosphere",compositionCategories:["path","atmosphere"],visualTraits:["bridge","fog","dream"],attributes:{dream:4,eerie:3,memory:1},roomEffects:{calmStrength:1,lightPenalty:1},visualEffect:{type:"dream-road",color:"#aeb8cd",density:9},designPosition:"通向梦境的可变路径；方向不稳定，也不适合害怕未知的人。",roomAction:"在客房里铺出一条只在入睡后显现的梦境路径。"}],
    "memory-seal":["记忆封印",5,"component","lock","影锁扣住回忆残响，把一段记忆变成守住房间边界的封印。",["advanced_result","protective","lock","memory_object","spiritual"],{roomRole:"wall",compositionCategories:["protection","memory"],visualTraits:["lock","shadow","memory"],attributes:{dream:1,eerie:2,memory:4},roomEffects:{protectionStrength:5},visual:{variant:"memory-seal"},designPosition:"以记忆为代价维持边界的灵性防护；可靠，但会让旧事留得更久。",roomAction:"用一段记忆守住房间边界，同时保存曾在这里留下的痕迹。"}],
    "everwarm-hearth":["恒温炉心",5,"component","fire","蒸汽暖气与炉心形成缓慢循环，让暖意不再只停在一个角落。",["advanced_result","heater","stable_heat","mechanical"],{roomRole:"furniture",compositionCategories:["heat","mechanical"],visualTraits:["fire","steam","metal"],attributes:{light:1,warmth:4,comfort:3},roomEffects:{heatPersistence:5,mechanicalStrength:1},visual:{variant:"everwarm-hearth",lightColor:"#e8a568",glowRadius:142,glowIntensity:.38},designPosition:"持续而均匀的暖源；比壁炉稳定，但带有很轻的机械存在感。",roomAction:"让暖意持续流遍整间客房，而不是只停在火源附近。"}]
  };
  const DAY4_ADVANCED_IDS=Object.freeze(["breathing-drive","echo-observatory","time-anchor","dream-road","memory-seal","everwarm-hearth"]);
  const recipeSpecs=[
    ...
    ["gear-core","hearth-core","breathing-drive"],["gear-core","signal-eye","echo-observatory"],
    ["hourglass-sand","rust-machine","time-anchor"],["fog-bridge","dream-hourglass","dream-road"],
    ["shadow-lock","memory-echo","memory-seal"],["steam-heater","hearth-core","everwarm-hearth"]
  ].map(([a,b,id])=>({a,b,id,label:outputDefs[id][0],level:outputDefs[id][1],iconKey:outputDefs[id][3],unlockDay:DAY4_ADVANCED_IDS.includes(id)?4:1}));
  ...
  const MATERIAL_PURPOSES=Object.freeze({INTERMEDIATE:"INTERMEDIATE",ROOM_COMPONENT:"ROOM_COMPONENT",NEGATIVE_EXAMPLE:"NEGATIVE_EXAMPLE",SPECIAL_INTERACTION:"SPECIAL_INTERACTION",COLLECTIBLE:"COLLECTIBLE",ADVANCED_CHAIN_SEED:"ADVANCED_CHAIN_SEED"});
  const purposeOverrides={"cold-light":"INTERMEDIATE","shadow-fog":"INTERMEDIATE","dream-sand":"INTERMEDIATE",echo:"INTERMEDIATE",ember:"INTERMEDIATE","rust-shard":"INTERMEDIATE",static:"INTERMEDIATE","window-frame":"INTERMEDIATE","moon-dust":"INTERMEDIATE","dark-door":"ROOM_COMPONENT","fog-bridge":"ROOM_COMPONENT","frost-water":"ROOM_COMPONENT","quiet-breeze":"ROOM_COMPONENT","memory-letter":"ROOM_COMPONENT","moss-floor":"ROOM_COMPONENT","cloud-bed":"ROOM_COMPONENT","gear-core":"ADVANCED_CHAIN_SEED","ice-wind":"NEGATIVE_EXAMPLE","mechanical-noise":"NEGATIVE_EXAMPLE",sandstorm:"NEGATIVE_EXAMPLE","bone-armor":"SPECIAL_INTERACTION"};
  for(const element of Object.values(library)){element.continuationCount=continuationCounts.get(element.id)||0;element.canReactFurther=element.level>1&&element.continuationCount>0;element.materialPurpose=purposeOverrides[element.id]||(element.roomRole?MATERIAL_PURPOSES.ROOM_COMPONENT:element.canReactFurther?MATERIAL_PURPOSES.INTERMEDIATE:element.tags?.some(tag=>["noise","cold","harsh_light"].includes(tag))?MATERIAL_PURPOSES.NEGATIVE_EXAMPLE:MATERIAL_PURPOSES.COLLECTIBLE);element.contentRole=element.materialPurpose}
  const ADVANCED_CHAIN_PLAN=Object.freeze([
    Object.freeze({seed:"gear-core",theme:"机械生命",possibleInputs:Object.freeze(["mechanical-heart","ember","echo"]),futureOutputs:Object.freeze(["呼吸驱动核","寄居机械"]),targetNpcTypes:Object.freeze(["mechanic","oddity-lover"]),targetRecipeDepth:3,distinction:"不是再次制造机械心脏，而是让动力装置获得呼吸与响应。"}),
    Object.freeze({seed:"gear-core",theme:"房间观测",possibleInputs:Object.freeze(["static","light-eye","memory-letter"]),futureOutputs:Object.freeze(["回声观测台","旅店信标"]),targetNpcTypes:Object.freeze(["mechanic","mystery"]),targetRecipeDepth:3,distinction:"不同于信号眼的单点扫描，目标是记录整个房间发生过的变化。"}),
    Object.freeze({seed:"gear-core",theme:"时间锚定",possibleInputs:Object.freeze(["hourglass-sand","rust-shard","moon-dust","dream-sand"]),futureOutputs:Object.freeze(["时序锚","停驻时室"]),targetNpcTypes:Object.freeze(["elder","dreamwalker","mystery"]),targetRecipeDepth:3,distinction:"不负责报时，而是固定、延缓或重放房间中的一段时间。"})
  ]);
  const evolutionSpecs=[
    ["moon-memory-room","月下记忆室","冷白月色与旧日映像共同塑造的安静房间。",["upgrade","memory","dream"],{light:1,dream:2,memory:2}],
    ["fog-bedroom","雾中寝室","光线柔软、薄雾缓慢流动的休息空间。",["upgrade","dream","soft"],{dream:2,comfort:2}],
    ["mechanical-lab","机械实验间","墙面、节律和装置都带有机械秩序的硬朗空间。",["upgrade","mechanical"],{}]
  ];
  ...
  root.REACTOR_DATA={
    ATTRIBUTE_KEYS:Object.freeze(ATTRIBUTE_KEYS),normalizeRoomStats,ITEM_TAGS,TAG_META,TAG_ALIASES,normalizeItemTags,OWNERSHIP_TYPES,MATERIAL_PURPOSES,ADVANCED_CHAIN_PLAN,DAY4_ADVANCED_IDS,elementLibrary:Object.freeze(library),
